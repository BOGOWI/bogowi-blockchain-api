...
async function main() {
  console.log("💰 Minting Remaining BOGO Tokens (Final)\n");
  ...
  // Check current supply and allocations using available functions
  ...
  // Get remaining allocations using the available getter functions
